...
import com.alten.remotesync.application.assignedRotation.record.response.RcCountCurrentAssociateOnSiteDTO;
...
public interface AssignedRotationMapper {
    ...
    RcCountCurrentAssociateOnSiteDTO toRcCountCurrentAssociateOnSite(Long countCurrentAssociateOnSite);
}
